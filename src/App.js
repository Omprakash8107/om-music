...
function App() {
  ...
  const [currentMusicDetails, setCurrentMusicDetails] = useState({
    songName: 'Mann Bharyy',
      songArtist: 'B Praak',
      songSrc: './Assets/songs/WhatsApp Audio 1.mp3',
  ...
  const musicAPI = [
    ...
    {
      songName: 'Prada',
      songArtist: 'Jass Manak ',
      songSrc: './Assets/songs/WhatsApp Audio 2.mp3',
      songAvatar: './Assets/Images/image2.jpg'
    },
    {
      songName: 'Pal',
      songArtist: 'Arijit Singh and Shreya Ghoshal',
      songSrc: './Assets/songs/WhatsApp Audio 3.mp3',
      songAvatar: './Assets/Images/image3.jpg'
    },
    {
      songName: 'Father Saab',
      songArtist: 'Khasa Aala Chahar',
      songSrc: './Assets/songs/WhatsApp Audio 4.mp3',
      songAvatar: './Assets/Images/image4.jpg'
    },
    {
      songName: 'Aankhon Mein Teri[ slowed + reverb ]',
      songArtist: 'KK',
      songSrc: './Assets/songs/WhatsApp Audio 5.mp3',
      songAvatar: './Assets/Images/image5.jpg'
    },
    {
      songName: 'krishna Chetavani ',
      songArtist: 'Agam Aggarwal',
      songSrc: './Assets/songs/WhatsApp Audio 6.mp3',
      songAvatar: './Assets/Images/image6.jpg'
    },
    {
      songName: 'Raabta',
      songArtist: 'Arijit Singh and Shreya Ghoshal',
      songSrc: './Assets/songs/WhatsApp Audio 7.mp3',
      songAvatar: './Assets/Images/image7.jpg'
    },
    {
      songName: 'Main Rang Sharbaton Ka',
      songArtist: 'Atif Aslam and Chinmayi',
      songSrc: './Assets/songs/WhatsApp Audio 8.mp3',
      songAvatar: './Assets/Images/image8.jpg'
    },
    {
      songName: 'bewajah',
      songArtist: 'Himesh Reshammiya',
      songSrc: './Assets/songs/WhatsApp Audio 9.mp3',
      songAvatar: './Assets/Images/image9.jpg'
    },
    {
      songName: 'Ae Dil Hai Mushkil',
      songArtist: 'Arijit Singh',
      songSrc: './Assets/songs/WhatsApp Audio 10.mp3',
      songAvatar: './Assets/Images/image10.jpg'
    },
    {
      songName: 'Bapu',
      songArtist: 'Amar Sandhu',
      songSrc: './Assets/songs/WhatsApp Audio 11.mp3',
